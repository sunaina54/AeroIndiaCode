...
public class WhereAmActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        headerTV.setText(getResources().getString(R.string.where_am1));
        ...
        AppUtilityCustom.statusCheck(WhereAmActivity.this);
...
*/
        if (mMap != null) {
            ...
            if (location != null) {
                ...
                lastMarker.setIcon(BitmapDescriptorFactory.fromBitmap(iconFactory.makeIcon("Location")));
