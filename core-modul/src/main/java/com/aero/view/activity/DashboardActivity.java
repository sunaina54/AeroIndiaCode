...
import com.aero.view.fragment.Fragment_Main;
...
//                }
      ...
      /*  slider = (Slider) findViewById(R.id.slider);
        ...
        pager = (EnhancedWrapContentViewPager)
        ...
        btnViewPagerLayout = (LinearLayout)

                findViewById(R.id.btnViewPagerLayout);

        pagerlayout = (LinearLayout)
  ...
  /*      announcementItemsModels.add(new AnnouncementItemsModel(0,
        ...
        announcementItemsModels.add(new

                AnnouncementItemsModel(0, R.drawable.banner_default, getResources().

                getDimensionPixelSize(R.dimen.slider_image_corner)));

        announcemnetResponse = announcemnetResponse.create(

                loadAnnouncementJSONFromAsset());

        if (announcemnetResponse != null && announcemnetResponse.getAnnouncementItemsModels() != null
                && announcemnetResponse.getAnnouncementItemsModels().
        ...
        String title = "";
        Fragment fragment = new NewUserMyDashboard();
        title =

                getString(R.string.head_dashboard);
