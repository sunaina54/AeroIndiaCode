...
public class Camera2BasicFragment extends Fragment implements View.OnClickListener, ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        cameraForB = getActivity().getIntent().getIntExtra("camera_key", AppConstant.FRONT_CAMREA_OPEN);
        purpose = getActivity().getIntent().getStringExtra("purpose");
        screenName=getActivity().getIntent().getStringExtra("screen");
    }
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                if (cameraForB == AppConstant.FRONT_CAMREA_OPEN) {
                    ...
                    new CameraCaptureSession.StateCallback() {
                        ...
                        public void onConfigured(@NonNull CameraCaptureSession cameraCaptureSession) {
                            ...
                            try {
                                ...
                                if (mCaptureCallback != null && mBackgroundHandler != null) {
...
//                    unlockFocus();
                        ...
                        Intent i = new Intent();
                        i.putExtra("response", mFile.getAbsolutePath());
